	...
	return (
		<>
						...
						<div className="col-lg-3 col-sm-6">
							<div className="single-footer-widget">
								...
								<ul className="info">
									<li>
										<span>Call Us:</span>{" "}
										<a href="tel:021111-503-504">
										(021) 111-503-504
										</a>
									</li>
									<li>
										<span>Address:</span> 501,Quaideen Colony, Karachi
									</li>
									<li>
										<span>Mail Us:</span>{" "}
										<a href="mailto:help@banoqabil.pk">
										help@banoqabil.pk
										</a>
									</li>
								</ul>
			...
			<div className="copy-right-area bg-color-f6fafb">
				<div className="container">
					<p>
						&copy; Bano Qabil {currentYear} is Proudly Owned by{" "}
						<a href="https://alkhidmat.com/" target="_blank">
						Alkhidmat Lahore
						</a>
					</p>
				</div>
